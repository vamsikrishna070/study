...
toast.success = (description: string): ToastReturn => {
  return toast({
    variant: "success",
    title: "Success",
    description,
...
toast.error = (description: string): ToastReturn => {
  return toast({
    variant: "destructive",
    title: "Error",
    description,
...
toast.warning = (description: string): ToastReturn => {
  return toast({
    variant: "destructive",
    title: "Warning",
    description,
...
toast.info = (description: string): ToastReturn => {
  return toast({
    variant: "default",
    description,
  })
...
export type { ToasterToast, Toast, ToastReturn, UseToastReturn }