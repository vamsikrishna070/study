...
const reminderSchema = new mongoose.Schema({
  ...
  scheduleType: { type: String, enum: ['one-time', 'daily', 'weekly', 'monthly', 'yearly'], default: 'one-time' },
  ...
  soundPreference: { type: String, enum: ['default', 'local'], default: 'default' },
  soundName: { type: String },
  soundUri: { type: String },
